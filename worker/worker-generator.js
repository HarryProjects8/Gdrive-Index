...
const jsURL = 'https://raw.githubusercontent.com/HarryProjects8/Gdrive-Index/master/worker/worker-super.js';

async function handleRequest(request) {
    let title = getParameterByName(request.url, 'site_name') || 'Jitish Drive Index';
...
<head>
    ...
    <title>Jitish Drive Index - Beta</title>
